    ...
    return (
        <div className="w-full h-full bg-slate-200 ">
            <div className="w-full h-24 flex items-center justify-center bg-slate-100">
                ...
                <div className="bg-slate-200 h-screen md:flex border-myColor text-center  inline md:justify-center items-center text-[#012A4A]">
                    <div className="bg-myColor rounded-sm border-2 flex shadow-4xl border-myColor md:ml-10 md:rounded-2xl">
                    {/* <ImageSlide/> */}
                        <img className="rounded-xl  bg-slate-100" src="/image/screenShot2.png" width={1000} height={1000} alt="" />
                        
                    </div>
                    <div className="md:inline justify-center md:w-4/5 px-2">
                <div className="mt-16 text-center items-center justify-around md:m-10 mb-10 md:mb-28 bg-slate-100 rounded-3xl p-3 shadow-lg">
...
Онлайн видео хурлаар дамжуулан илүү сайн харилцах, хамтран ажиллах, санаа бодлоо илэрхийлэх. Ширээний камер эсвэл гадаад камерыг онлайн видео уулзалтад ашиглаж, төөрөгдөл, ойлгомжгүй  байдалд орон зай үлдээлгүй нүүр тулсан хамтын ажиллагаагаар зөвшилцөлд хүрээрэй.</p>
                ...
                <div className="text-[#012A4A] text-start  justify-around md:grid md:grid-cols-2 md:gap-8 md:m-10 grid grid-cols-1 gap-8">
                    <div className="bg-slate-100 rounded-3xl p-3 shadow-lg ">
