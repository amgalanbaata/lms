    ...
    return (
        <div className="w-full h-full bg-slate-50 ">
            <div className="w-full h-24 flex items-center justify-center bg-slate-100">
                ...
                <div className="bg-slate-50 h-screen md:flex border-myColor text-center  inline md:justify-center items-center text-[#012A4A]">
                    <div className="bg-myColor rounded-sm border-2 flex border-myColor md:ml-10 md:rounded-2xl">
                    {/* <ImageSlide/> */}
                        <img className="rounded-xl shadow-md" src="/image/screenShot2.png" width={1000} height={1000} alt="" />
