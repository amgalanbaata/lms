...
export default function NewsBoard() {
    return (
        <div className="w-full h-full bg-myColor">
            ...
            <div className="bg-myColor inline md:flex items-center h-[100vh">
                <div className="text-3xl sm:w-2/4 sm:leading-loose justify-center items-center inline md:p-24 p-3 ">
                    ...
                    <div class="mx-auto md:inline max-w-8xl w-full bg-myColor py-10 md:w-2/4">
                        <div class=" flex [&:hover>div]:w-16 [&>div:hover]:w-[30rem]">
                            <div class="group relative h-96 md:h-[70vh] w-[30rem] cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-500">
                                <img
                            ...
                            <div class="group relative w-16 cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-500">
                                <img
                                    class="h-full object-cover transition-all group-hover:rotate-12 group-hover:scale-125"
                            ...
                            <div class="group relative h- w-16 cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-500">
                                <img
                                    class="rounded-r-lg h-full object-cover transition-all group-hover:rotate-12 group-hover:scale-125"
